    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          Create a professional resume that stands out with our AI-driven tools.
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Get started now.</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
...
// Updated Items Array for Resume Builder and Analyzer
const items = [
  {
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Get detailed feedback on your resume with AI-powered analysis.
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Export your resume in multiple formats and share it effortlessly.
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
