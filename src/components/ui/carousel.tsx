  ...
  return (
    ...
    >
      <div className="relative w-full">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto py-8 md:py-16 scroll-smooth [scrollbar-width:none]"
          ref={carouselRef}
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="rounded-3xl bg-gray-100 dark:bg-neutral-900 h-64 w-48 md:h-[32rem] md:w-[300px] overflow-hidden flex flex-col items-start justify-start relative z-10 shadow-lg transition-shadow duration-300"
        whileHover={{ 
          y: -8,
